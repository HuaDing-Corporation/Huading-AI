        ...
        db.add_all(
            [
                Asset(
                    ...
                    type="audio",
                    source="upload",
                    storage_key="tenants/lifecycle-tenant/uploads/create.wav",
                    mime_type="audio/wav",
                    duration_ms=10_000,
                    status="ready",
                ),
                Asset(
                    ...
                    type="audio",
                    source="upload",
                    storage_key="tenants/lifecycle-tenant/uploads/renew-old.wav",
                    mime_type="audio/wav",
                    duration_ms=10_000,
                    status="ready",
                ),
                Asset(
                    ...
                    type="audio",
                    source="upload",
                    storage_key="tenants/lifecycle-tenant/uploads/renew-new.wav",
                    mime_type="audio/wav",
                    duration_ms=10_000,
                    status="ready",
                ),
