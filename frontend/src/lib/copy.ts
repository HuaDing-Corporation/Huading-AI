export const copy = {
  ...
  workbench: {
    ...
    ecomPlanColRef: "对应参考图",
    ecomPlanColMainTitle: "主标题",
    ecomPlanColSubTitle: "副标题 / 卖点",
    ecomPlanColStyle: "展示方式",
    ecomPlanColSize: "尺寸",
    ecomPlanColOutput: "最终输出",
    ecomPlanReusedBadge: "循环复用",
    ecomPlanReuseHint: "参考图不足，部分页将循环复用模板（每页主题不同）；确认后不再追问",
    ...
    // 名词中性版越限提示（供复用 picker 如电商详情图·商品图，避免误显「参考图」）
    refImagesOverLimit: "最多 9 张，超出部分未添加",
    vgPromptLabel: "提示词",
